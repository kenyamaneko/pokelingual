...
describe("ScoreDisplay", () => {
  it("displays damage and HP", () => {
    ...
    render(<ScoreDisplay score={{ score: 85 }} />);
  ...
  it("shows いちげきひっさつ for score 100", () => {
    ...
    render(<ScoreDisplay score={{ score: 100 }} />);
  ...
  it("shows no label for score 41-79", () => {
    ...
    render(<ScoreDisplay score={{ score: 60 }} />);
  ...
  it("shows いまひとつ for score 1-40", () => {
    ...
    render(<ScoreDisplay score={{ score: 15 }} />);
  ...
  it("shows こうかがない for score 0", () => {
    ...
    render(<ScoreDisplay score={{ score: 0 }} />);
